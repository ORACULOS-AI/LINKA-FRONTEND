...
export function DashboardChartsImproved({ data }: DashboardChartsProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      >
        <Card className="relative overflow-hidden bg-white border-2 border-gray-100 hover:border-purple-300 hover:shadow-xl transition-all duration-300 h-full">
      ...
      >
        <Card className="relative overflow-hidden bg-white border-2 border-gray-100 hover:border-purple-300 hover:shadow-xl transition-all duration-300 h-full">
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-500 via-violet-500 to-purple-600" />
          <CardHeader className="pt-6">
            <CardTitle className="text-gray-900">Top 10 Áreas Estratégicas</CardTitle>
      ...
      {modalidadeData.length > 0 && (
        ...
        >
          <Card className="relative overflow-hidden bg-white border-2 border-gray-100 hover:border-purple-300 hover:shadow-xl transition-all duration-300 h-full">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-500 via-violet-500 to-purple-600" />
            <CardHeader className="pt-6">
              <CardTitle className="text-gray-900">Modalidade de Instalação</CardTitle>
      ...
      {laboratoriosPorCampus.length > 0 && (
        ...
        >
          <Card className="relative overflow-hidden bg-white border-2 border-gray-100 hover:border-purple-300 hover:shadow-xl transition-all duration-300 h-full">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-500 via-violet-500 to-purple-600" />
            <CardHeader className="pt-6">
              <CardTitle className="text-gray-900">Laboratórios por Campus</CardTitle>
